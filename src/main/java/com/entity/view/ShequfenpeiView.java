...
public class ShequfenpeiView extends ShequfenpeiEntity implements Serializable {
	...
	public ShequfenpeiView() {

	}

	public ShequfenpeiView(ShequfenpeiEntity shequfenpeiEntity) {
		try {
			BeanUtils.copyProperties(this, shequfenpeiEntity);
