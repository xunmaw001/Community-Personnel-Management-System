...
public class ShequjubaoEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShequjubaoEntity() {

	}

	public ShequjubaoEntity(T t) {
		try {
    ...
    public String toString() {
        return "Shequjubao{" +
            "id=" + id +
            ", shequId=" + shequId +
            ", shequjubaoName=" + shequjubaoName +
            ", shequjubaoTypes=" + shequjubaoTypes +
            ", shequjubaoContent=" + shequjubaoContent +
