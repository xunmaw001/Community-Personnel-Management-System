<template>
    <div style="backgroundImage: url('/shequrenyuanguanli/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">社区人员管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="手机号" class="input" v-if="tableName=='gongzuorenyuan'">
                            <el-input v-model="ruleForm.gongzuorenyuanPhone" autocomplete="off" placeholder="手机号"  />
                        </el-form-item>
                        ...
                        <el-form-item label="居民姓名" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="居民姓名"  />
                        </el-form-item>
